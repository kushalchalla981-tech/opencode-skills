...
description: "Expert knowledge of OpenCode's internal architecture, including agent loops, tool permissions, prompt engineering, and state management. Use when analyzing or re-implementing advanced AI agent patterns."
---
...
OpenCode uses a `buildTool()` function that creates comprehensive tool definitions with:
...
OpenCode implements a sophisticated permission system with:
...
4. **Memory Content**: `.OpenCode AI.md` and `OpenCode AI.md` files
...
- **Project Memory**: `OpenCode AI.md` in project root
- **User Memory**: `.OpenCode AI.md` in user home directory
...
### Sandbox Integration
OpenCode implements optional sandboxing for shell commands:
